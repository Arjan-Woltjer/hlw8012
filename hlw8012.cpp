...
void HLW8012Component::setup() {
  ...
  this->voltage_multiplier = this->voltage_constant_ / 10000;
  this->current_multiplier = this->current_constant_ / 100000;
  this->power_multiplier   = this->power_constant_   / 1000;
}
